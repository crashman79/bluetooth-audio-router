...
- **App**: Standalone GUI for per-app audio routing (PipeWire/PulseAudio). Primary run: download binary from Releases or `./build.sh` then `./dist/sinkswitch`. Config: `~/.config/pipewire-router/`.
